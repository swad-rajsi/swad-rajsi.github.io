...
<form id="contactMeForm" class="swad-rajsi-centre-display contact-form style" action="https://formspree.io/f/xqarjooq" method="POST">
...
<div class="contact-me-form-group">
<textarea name="message" rows="10" type="meassage"  class="contact-me-message-box contact-me-underline-input" required placeholder="Message"></textarea>
</div>
